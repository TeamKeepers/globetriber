 ...
 */
class Version20180220182209 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tribe (id INT AUTO_INCREMENT NOT NULL, id_sender_id INT DEFAULT NULL, id_receiver_id INT DEFAULT NULL, INDEX IDX_2653B55876110FBA (id_sender_id), INDEX IDX_2653B558D5412041 (id_receiver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, description TEXT NOT NULL, activity_status TINYINT(1) DEFAULT \'0\' NOT NULL, roles VARCHAR(255) NOT NULL, photo_profile VARCHAR(255) DEFAULT \'default\' NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recommendation (id INT AUTO_INCREMENT NOT NULL, place_id INT DEFAULT NULL, user_id INT DEFAULT NULL, validation TINYINT(1) NOT NULL, comment TEXT NOT NULL, INDEX IDX_433224D2DA6A219 (place_id), INDEX IDX_433224D2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, description TEXT NOT NULL, internet VARCHAR(100) NOT NULL, image VARCHAR(255) DEFAULT \'default\' NOT NULL, accessibility TINYINT(1) NOT NULL, kitchen TINYINT(1) NOT NULL, parking TINYINT(1) NOT NULL, address VARCHAR(255) NOT NULL, town VARCHAR(100) DEFAULT NULL, lng NUMERIC(11, 8) NOT NULL, lat NUMERIC(11, 8) NOT NULL, country VARCHAR(100) NOT NULL, bed INT NOT NULL, desk TINYINT(1) NOT NULL, airConditioning TINYINT(1) NOT NULL, washingMachine TINYINT(1) NOT NULL, outlet VARCHAR(255) NOT NULL, other VARCHAR(255) DEFAULT NULL, capacity INT DEFAULT NULL, privateDesk TINYINT(1) NOT NULL, computer TINYINT(1) NOT NULL, printer TINYINT(1) NOT NULL, scanner TINYINT(1) NOT NULL, projector TINYINT(1) NOT NULL, napStation TINYINT(1) NOT NULL, whiteBoard TINYINT(1) NOT NULL, terrace TINYINT(1) NOT NULL, freeDrink TINYINT(1) NOT NULL, freeSnack TINYINT(1) NOT NULL, types VARCHAR(255) NOT NULL, INDEX IDX_741D53CDA76ED395 (user_id), INDEX IDX_741D53CD7E3C61F9 (owner_id), INDEX bed_index (bed), INDEX desk_index (desk), INDEX airConditioning_index (airConditioning), INDEX washingMachine_index (washingMachine), INDEX outlet_index (outlet), INDEX other_index (other), INDEX capacity_index (capacity), INDEX privateDesk_index (privateDesk), INDEX computer_index (computer), INDEX printer_index (printer), INDEX scanner_index (scanner), INDEX projector_index (projector), INDEX napStation_index (napStation), INDEX whiteBoard_index (whiteBoard), INDEX terrace_index (terrace), INDEX freeDrink_index (freeDrink), INDEX freeSnack_index (freeSnack), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE recommendation ADD CONSTRAINT FK_433224D2DA6A219 FOREIGN KEY (place_id) REFERENCES place (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE recommendation DROP FOREIGN KEY FK_433224D2DA6A219');
